export const profile = {
  ...
  tagline:
    "Cloud & Distributed Systems • Reliability & Observability • AI Infrastructure",
  ...
  caseStudies: [
    {
      ...
      problem:
        "Incidents took too long to diagnose due to inconsistent logs and missing traceability.",
      approach:
  ...
  principles: [
    {
      ...
      desc: "SLOs, graceful degradation, and resilient patterns from day one.",
    },
    {
      title: "Observability first",
      desc: "Logs/metrics/traces with correlation IDs and actionable alerts.",
    },
    {
      title: "Performance as a feature",
      desc: "Profiling, load testing, and caching to protect p95/p99.",
    },
    {
      title: "Secure defaults",
      desc: "Least privilege, secrets hygiene, and safe-by-default APIs.",
    },
    {
      title: "Automation over toil",
      desc: "CI/CD, runbooks, dashboards, and self-healing workflows.",
    },
    {
      title: "Readable systems",
      desc: "Clean boundaries, clear ownership, and documentation that scales.",
    },
  ],
};
